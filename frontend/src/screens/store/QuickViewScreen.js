              ...
              <div className="product-right">
                ...
                >
                  <div className="intro-slide" data-hash="one">
                    <img
                      src="../../../../www.portotheme.com/html/molla/popup/assets/images/popup/quickView/1.html"
                      alt="Image Desc"
                    />
                    <a
                  ...
                  <div className="intro-slide" data-hash="two">
                    <img
                      src="../../../../www.portotheme.com/html/molla/popup/assets/images/popup/quickView/2.html"
                      alt="Image Desc"
                    />
                    <a
                      href="https://www.portotheme.com/html/molla/popup/popup/fullscreen.html"
                  ...
                  <div className="intro-slide" data-hash="three">
                    <img
                      src="../../../../www.portotheme.com/html/molla/popup/assets/images/popup/quickView/3.html"
                      alt="Image Desc"
                    />
                    <a
                      href="https://www.portotheme.com/html/molla/popup/popup/fullscreen.html"
                  ...
                  <div className="intro-slide" data-hash="four">
                    <img
                      src="../../../../www.portotheme.com/html/molla/popup/assets/images/popup/quickView/4.html"
                      alt="Image Desc"
                    />
                    <a
                      href="https://www.portotheme.com/html/molla/popup/popup/fullscreen.html"
          ...
          <div className="col-lg-5 col-md-6">
            ...
            <div className="details-filter-row product-nav product-nav-thumbs">
              ...
              <a href="#" className="active">
                <img
                  src="../../../../www.portotheme.com/html/molla/popup/assets/images/demos/demo-6/products/product-1-thumb.html"
                  alt="product desc"
                />
              </a>
              <a href="#">
                <img
                  src="../../../../www.portotheme.com/html/molla/popup/assets/images/demos/demo-6/products/product-1-2-thumb.html"
                  alt="product desc"
                />
              </a>
            </div>

            ...
            >
              <div className="product product-3 text-center">
                ...
                <div className="product-footer">
                  ...
                  <div className="product-nav product-nav-dots">
                    <a href="#" className="active" style={{background: '#5f554b'}}>
              ...
              <div className="product product-3 text-center">
                <figure className="product-media">
                  <a href="product.html">
                    <img
                      src="assets/images/demos/demo-10/products/product-2.jpg"
                      alt="Product image"
                      className="product-image"
                    />
                  </a>
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title">
                    <a href="product.html">Nike Air Zoom Wildhorse 4</a>
                  </h3>
              ...
              <div className="product product-3 text-center">
                <figure className="product-media">
                  ...
                  <a href="product.html">
                    <img
                      src="assets/images/demos/demo-10/products/product-3.jpg"
                      alt="Product image"
                      className="product-image"
                    />
                    <img
                      src="assets/images/demos/demo-10/products/product-3-2.jpg"
                      alt="Product image"
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title">
                    <a href="product.html">Eric Michael Joan</a>
                  </h3>
                ...
                <div className="product-footer">
                  ...
                  <div className="product-nav product-nav-dots">
                    ...
                    <a href="#" style={{background: '#b58853'}}>
                      <span className="sr-only">Color name</span>
                    </a>
                  </div>
              ...
              <div className="product product-3 text-center">
                <figure className="product-media">
                  ...
                  <a href="product.html">
                    <img
                      src="assets/images/demos/demo-10/products/product-4.jpg"
                      alt="Product image"
                      className="product-image"
                    />
                  </a>
                ...
                <div className="product-body">
                  ...
                  <h3 className="product-title">
                    <a href="product.html">Nike Air Max Motion LW Racer</a>
                  </h3>
                  <div className="product-price">

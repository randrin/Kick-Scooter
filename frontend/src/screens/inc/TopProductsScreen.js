                ...
                <div className="product product-3 text-center">
                  ...
                  <div className="product-footer">
                    ...
                    <div className="product-nav product-nav-dots">
                      <a href="#" className="active" style={{background: '#af5f23'}}>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    ...
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-6.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-7.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
                  ...
                  <div className="product-footer">
                    ...
                    <div className="product-nav product-nav-dots">
                      <a href="#" className="active" style={{background: '#cc6666'}}>
                        <span className="sr-only">Color name</span>
                      </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-8.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
                  ...
                  <div className="product-body">
                    ...
                    <h3 className="product-title">
                      <a href="product.html">Native Shoes Miles Denim Print</a>
                    </h3>
                    <div className="product-price">$20.99</div>
                  </div>
                  ...
                  <div className="product-footer">
                    ...
                    <div className="product-nav product-nav-dots">
                      <a href="#" className="active" style={{background: '#ffca51'}}>
                        <span className="sr-only">Color name</span>
                      </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-9.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-10.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-11.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
                  ...
                  <div className="product-footer">
                    ...
                    <div className="product-nav product-nav-dots">
                      <a href="#" className="active" style={{background: '#78645f'}}>
                        <span className="sr-only">Color name</span>
                      </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    ...
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-12.jpg"
                        alt="Product image"
                        className="product-image/"
                      />
                    </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    ...
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-13.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>
              ...
              <div className="col-6 col-md-4 col-lg-3 col-xl-5col">
                <div className="product product-3 text-center">
                  <figure className="product-media">
                    <a href="product.html">
                      <img
                        src="assets/images/demos/demo-10/products/product-14.jpg"
                        alt="Product image"
                        className="product-image"
                      />
                    </a>

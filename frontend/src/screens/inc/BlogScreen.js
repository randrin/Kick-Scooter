        ...
        >
          <article className="entry">
            <figure className="entry-media">
              <a href="single.html">
                <img
                  src="assets/images/demos/demo-10/blog/post-1.jpg"
                  alt="image desc"
                />
              </a>
            </figure>
          ...
          <article className="entry">
            <figure className="entry-media">
              <a href="single.html">
                <img
                  src="assets/images/demos/demo-10/blog/post-2.jpg"
                  alt="image desc"
                />
              </a>
            </figure>
          ...
          <article className="entry">
            <figure className="entry-media">
              <a href="single.html">
                <img
                  src="assets/images/demos/demo-10/blog/post-3.jpg"
                  alt="image desc"
                />
              </a>
            </figure>
          ...
          <article className="entry">
            <figure className="entry-media">
              <a href="single.html">
                <img
                  src="assets/images/demos/demo-10/blog/post-4.jpg"
                  alt="image desc"
                />
              </a>
            </figure>
